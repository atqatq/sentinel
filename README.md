...
| `apps/web` | Next.js 15 app router: auth, plan, data-health, the §14.13c approvals tray + API route, the /audit time machine |
...
npm run test        # the structural battery (1,178) must pass — every suite green,
