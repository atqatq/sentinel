...
| `apps/web` | Next.js 15 app router: auth, plan, data-health, the §14.13c approvals tray + API route |
...
npm run test        # the structural battery (1,165) must pass — every suite green,
