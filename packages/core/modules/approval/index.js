 ...
 * configurable threshold, the supplier-identity change freeze, and (M7,
 * §14.13b) the conversion-factor governance — decided here, ENFORCED twice
 * (this layer AND the database: the RESTRICTIVE sod_binding policy + the
 * proposal_state_guard / supplier_identity_freeze / item_cf_freeze triggers).
 * Pure and deterministic: the principal, the tiers, the prior votes, the hold
 * rows and the version rows are always injected. Every refusal carries a
